                  ...
                  <div class="row">
                    <div id="edit" class="main-content-wrap container">
                      ...
                      <div>
                        ...
                        <form:form method="POST"  action="updateEmployee" class="form-content margin-top-24 form" role="form"
                            ...
                            <div class="form-body  col-xl-12 ">
                              ...
                              <div class="mb-3">
                                ...
                                <div class="flex-basic">
                                  <div class="check-group margin-lt-16">
                                    <form:radiobutton path="gender" value="1" id="male" /> <label for="male"
                              ...
                              <div class="mb-3">
                                <label for="account" class="form-label font-weight-bold">Account<span class="error">
                                    (*)</span></label>
                                       <form:input  path="account.accountId" type="hidden"/>
                                <form:input type="text" path="account.account" class="form-control" id="account" />
                              ...
                              <div class="mb-3">
                                <label for="email" class="form-label font-weight-bold">Email<span class="error">
                                    (*)</span></label>
                                <form:input type="email" path="account.email" class="form-control" id="email" />
                              ...
                              <div class="mb-3">
                                ...
                                <div class="flex-basic">
                                  <div class="check-group margin-lt-16">
                                    <form:checkbox value="1" path="account.status" id="status" /> <label for="status"
                                      class="margin-bm-0 margin-lt-8">Active</label>
                                  </div>
                                </div>
                              </div>
                              <div class="mb-3">
